...
def parse_opts():
    ...
    parser.add_argument('--sub_path',
                        default=None,
                        type=Path,
                        help='Result sub-directory path for individual experiments')
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'Number of classes (TinyVIRAT: 26, activitynet: 200, kinetics: 400 or 600, ucf101: 101, hmdb51: 51)'
    )
    ...
    parser.add_argument('--mean_dataset',
                        ...
                        help=('dataset for mean values of mean subtraction'
                              '(tinyvirat | activitynet | kinetics | 0.5)'))
    ...
    parser.add_argument('--n_threads',
                        default=4,
                        type=int,
                        help='Number of thread/workers for multi-thread loading')
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        '(resnet | resnet2p1d | preresnet | wideresnet | resnext | densenet | i3d')
